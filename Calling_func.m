...
plot_Pos_1 = BEAM_MAIN_program(210e9,7850,210e9,7850,15);
plot_Pos_2 = BEAM_MAIN_program(210e9,7850,210e9,7850,17);
plot_Pos_3 = BEAM_MAIN_program(210e9,7850,210e9,7850,19);
plot_Pos_4 = BEAM_MAIN_program(210e9,7850,210e9,7850,21 );
